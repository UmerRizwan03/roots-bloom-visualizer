    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-green-50 py-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <Link to="/magazines" className="text-emerald-600 font-medium">E-Magazines</Link>
            </nav>
          </div>
        </div>
      </header>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Family E-Magazines</h1>
            ...
            <Card key={magazine.id} className="overflow-hidden hover:shadow-xl transition-all duration-300 group">
              <div className="relative overflow-hidden">
                ...
                <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm px-2 py-1 rounded-md">
                  <span className="text-sm font-medium text-gray-700">{magazine.pages} pages</span>
                </div>
              </div>
              ...
              <CardContent className="pt-0">
                ...
                <div className="flex space-x-3">
                  ...
                  <button className="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-lg flex items-center justify-center space-x-2 transition-colors">
        ...
        {/* Stats Section */}
        <div className="mt-16 bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-200/50 p-8">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-2">Magazine Statistics</h3>
            <p className="text-gray-600">Our family publication journey</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <div className="text-3xl font-bold text-emerald-600 mb-2">{magazines.length}</div>
